...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://admin:password@my-rds-instance.cubaeu46y77l.us-east-1.rds.amazonaws.com:3306/AWS' # Edit SQL login for local machine
